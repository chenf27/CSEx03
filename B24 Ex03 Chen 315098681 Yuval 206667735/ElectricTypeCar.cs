...
namespace Ex03.GarageLogic
{
    public class ElectricTypeCar : Car
    {
        ...
        public ElectricTypeCar(ElectricTypeVehicleAttributes i_ElectricCar, eCarColor i_CarColor, int i_NumOfDoors, string i_ModelName, string i_LicensePlate, float i_EnergyLeftInTank)
